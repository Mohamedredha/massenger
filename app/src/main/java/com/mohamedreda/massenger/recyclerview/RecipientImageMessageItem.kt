...
import kotlinx.android.synthetic.main.recipient_item_image_message.*
...
class RecipientImageMessageItem(
    ...
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        viewHolder.textView_messages_time.text=android.text.format.DateFormat
        ...
        if (imageMessage.imagePath.isNotEmpty()){
            GlideApp.with(context)
                ...
                .into(viewHolder.imageView_message_images)}
    }
